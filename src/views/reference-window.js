...
function renderWhatsAppMessage(item) {
  ...
  if (item.kind === "replies") {
    return `
      <div class="whatsapp-chat__reply-group" aria-label="${escapeHtml(item.title || "Respuestas rápidas")}">
        ${item.options
          .map(
            (option) => `
              <button
  ...
  return `
    ...
    >
      <div class="whatsapp-modal__panel">
        ...
        <header class="whatsapp-chat__header">
          <div class="whatsapp-chat__brand">
            ...
            <div class="whatsapp-chat__brand-copy">
              <strong>ElenIA · Acompañamiento</strong>
              <span>Chat supervisado por Dra. Camila</span>
            </div>
          </div>
        ...
        <h2 id="whatsapp-modal-title" class="sr-only">
          ElenIA · Acompañamiento
        </h2>
        ...
        <div class="whatsapp-chat__context" data-whatsapp-context>
          <span data-whatsapp-context-patient>Paciente: Mariana Ríos</span>
          <span data-whatsapp-context-professional>Canal clínico activo</span>
          <span data-whatsapp-context-status>Historial con scroll</span>
        </div>
        ...
        >
          <div class="whatsapp-chat__note whatsapp-chat__loading">
            Preparando la conversaciÃ³n real...
          </div>
        </section>
